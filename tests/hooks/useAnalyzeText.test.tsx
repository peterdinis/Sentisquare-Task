...
describe('useAnalyzeText', () => {
  ...
  it('should call API and return data', async () => {
    const mockData: TextRazorResponse = {
      response: { entities: [{ entityId: '1', matchedText: 'George Bush', type: ['Person'], confidenceScore: 0.99 }] },
    };
    ...
    expect(mockedAxios.post).toHaveBeenCalledWith('/api/analyze', { text: 'George Bush was president of USA.' });
  });
